# Code for "Multi-Scale Motion Representation Learning for Video-based Parkinson's Disease Tremor Assessment"
...
# ---- ViT/Transformer friendly LR schedule (warmup + cosine + min_lr) ----
parser.add_argument('--warmup-epochs', '--warmup_epochs',
                    dest='warmup_epochs', type=int, default=0,
                    help='warmup epochs for cosine lr (0 disables warmup)')

parser.add_argument('--min-lr', '--min_lr',
                    dest='min_lr', type=float, default=0.0,
                    help='minimum lr for cosine decay (default 0.0)')